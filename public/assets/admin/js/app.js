...
window.App = {
  init: function init() {},
  toggleNavbar: function toggleNavbar(collapseID) {
  ...
  openDropdown: function openDropdown(event, dropdownID) {
    ...
    (0,_popperjs_core__WEBPACK_IMPORTED_MODULE_0__.createPopper)(element, document.getElementById(dropdownID), {
